...
C     
C     Process: grv > n1 u u~ $ z h01 / g u c d s u c d s ve vm vt e-
...
C     Process: grv > n1 c c~ $ z h01 / g u c d s u c d s ve vm vt e-
C      mu- ve vm vt e- mu- go ul cl t1 ur cr t2 dl sl b1 dr sr b2 ul
C      cl t1 ur cr t2 dl sl b1 dr sr b2 t b t b w+ h2 h3 h+ sve svm
C      svt el- mul- ta1- er- mur- ta2- w+ h+ sve svm svt el- mul- ta1-
C      er- mur- ta2- n1 n2 n3 n4 x1+ x2+ ta- x1+ x2+ ta- @2
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,4),W(1,3),GC_2,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FRV2_4C1_0(W(1,1),W(1,2),W(1,5),GC_1194,GC_695,AMP(1))
      CALL FFV2_9_3(W(1,4),W(1,3),GC_606,GC_623,MDL_MZ,MDL_WZ,W(1,5))
