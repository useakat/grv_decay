...
C     
C     Process: grv > n1 ta- ta+ $ z h01 / g u c d s u c d s ve vm vt
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFS1_11_3(W(1,4),W(1,3),GC_2239,GC_2250,MDL_MH01,MDL_WH01
     $ ,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FRS2_4_7_9C1_0(W(1,1),W(1,2),W(1,5),GC_2398,GC_2388,GC_2372
     $ ,GC_2288,AMP(2))
