...
C     
C     Process: grv > n1 e- e+ $ z h01 / g u c d s u c d s ve vm vt e-
C      mu- ve vm vt e- mu- go ul cl t1 ur cr t2 dl sl b1 dr sr b2 ul
C      cl t1 ur cr t2 dl sl b1 dr sr b2 t b t b w+ h2 h3 h+ sve svm
C      svt el- mul- ta1- er- mur- ta2- w+ h+ sve svm svt el- mul- ta1-
C      er- mur- ta2- n1 n2 n3 n4 x1+ x2+ ta- x1+ x2+ ta- @2
C     Process: grv > n1 mu- mu+ $ z h01 / g u c d s u c d s ve vm vt
C      e- mu- ve vm vt e- mu- go ul cl t1 ur cr t2 dl sl b1 dr sr b2
C      ul cl t1 ur cr t2 dl sl b1 dr sr b2 t b t b w+ h2 h3 h+ sve svm
C      svt el- mul- ta1- er- mur- ta2- w+ h+ sve svm svt el- mul- ta1-
C      er- mur- ta2- n1 n2 n3 n4 x1+ x2+ ta- x1+ x2+ ta- @2
C     
      USE DISCRETESAMPLER
...
C     
      ...
      DATA (NHEL(I,   1),I=1,4) /-3,-1,-1, 1/
      DATA (NHEL(I,   2),I=1,4) /-3,-1,-1,-1/
      DATA (NHEL(I,   3),I=1,4) /-3,-1, 1, 1/
      DATA (NHEL(I,   4),I=1,4) /-3,-1, 1,-1/
      DATA (NHEL(I,   5),I=1,4) /-3, 1,-1, 1/
      DATA (NHEL(I,   6),I=1,4) /-3, 1,-1,-1/
      DATA (NHEL(I,   7),I=1,4) /-3, 1, 1, 1/
      DATA (NHEL(I,   8),I=1,4) /-3, 1, 1,-1/
      ...
      DATA (NHEL(I,  25),I=1,4) / 3,-1,-1, 1/
      DATA (NHEL(I,  26),I=1,4) / 3,-1,-1,-1/
      DATA (NHEL(I,  27),I=1,4) / 3,-1, 1, 1/
      DATA (NHEL(I,  28),I=1,4) / 3,-1, 1,-1/
      DATA (NHEL(I,  29),I=1,4) / 3, 1,-1, 1/
      DATA (NHEL(I,  30),I=1,4) / 3, 1,-1,-1/
      DATA (NHEL(I,  31),I=1,4) / 3, 1, 1, 1/
      DATA (NHEL(I,  32),I=1,4) / 3, 1, 1,-1/
      DATA IDEN/ 4/
C     ----------
C     BEGIN CODE
C     ----------
...
C     ----------
      ...
      CALL OXXXXX(P(0,2),MDL_MNEU1,NHEL(2),+1*IC(2),W(1,2))
      CALL OXXXXX(P(0,3),ZERO,NHEL(3),+1*IC(3),W(1,3))
      CALL IXXXXX(P(0,4),ZERO,NHEL(4),-1*IC(4),W(1,4))
      CALL FFV1P0_3(W(1,4),W(1,3),GC_3,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FRV2_4C1_0(W(1,1),W(1,2),W(1,5),GC_1194,GC_695,AMP(1))
      CALL FFV2_9_3(W(1,4),W(1,3),GC_607,GC_624,MDL_MZ,MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FRV1_2_3_4C1_0(W(1,1),W(1,2),W(1,5),GC_1257,GC_1219,GC_1095
     $ ,GC_961,AMP(2))
