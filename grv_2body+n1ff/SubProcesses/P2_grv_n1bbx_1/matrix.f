...
C     
C     Process: grv > n1 b b~ $ z h01 / g u c d s u c d s ve vm vt e-
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,4),W(1,3),GC_1,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FRV2_4C1_0(W(1,1),W(1,2),W(1,5),GC_1194,GC_695,AMP(1))
      CALL FFS1_11_3(W(1,4),W(1,3),GC_2238,GC_2249,MDL_MH01,MDL_WH01
     $ ,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FRS2_4_7_9C1_0(W(1,1),W(1,2),W(1,5),GC_2398,GC_2388,GC_2372
     $ ,GC_2288,AMP(2))
      CALL FFV2_9_3(W(1,4),W(1,3),GC_607,GC_622,MDL_MZ,MDL_WZ,W(1,5))
