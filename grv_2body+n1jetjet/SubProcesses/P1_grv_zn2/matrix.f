...
C     
      ...
      DATA (NHEL(I,   1),I=1,3) /-3,-1,-1/
      DATA (NHEL(I,   2),I=1,3) /-3,-1, 1/
      DATA (NHEL(I,   3),I=1,3) /-3, 0,-1/
      DATA (NHEL(I,   4),I=1,3) /-3, 0, 1/
      DATA (NHEL(I,   5),I=1,3) /-3, 1,-1/
      DATA (NHEL(I,   6),I=1,3) /-3, 1, 1/
      DATA (NHEL(I,   7),I=1,3) /-1,-1,-1/
      DATA (NHEL(I,   8),I=1,3) /-1,-1, 1/
      DATA (NHEL(I,   9),I=1,3) /-1, 0,-1/
      DATA (NHEL(I,  10),I=1,3) /-1, 0, 1/
      DATA (NHEL(I,  11),I=1,3) /-1, 1,-1/
      DATA (NHEL(I,  12),I=1,3) /-1, 1, 1/
      DATA (NHEL(I,  13),I=1,3) / 1,-1,-1/
      DATA (NHEL(I,  14),I=1,3) / 1,-1, 1/
      DATA (NHEL(I,  15),I=1,3) / 1, 0,-1/
      DATA (NHEL(I,  16),I=1,3) / 1, 0, 1/
      DATA (NHEL(I,  17),I=1,3) / 1, 1,-1/
      DATA (NHEL(I,  18),I=1,3) / 1, 1, 1/
      DATA (NHEL(I,  19),I=1,3) / 3,-1,-1/
      DATA (NHEL(I,  20),I=1,3) / 3,-1, 1/
      DATA (NHEL(I,  21),I=1,3) / 3, 0,-1/
      DATA (NHEL(I,  22),I=1,3) / 3, 0, 1/
      DATA (NHEL(I,  23),I=1,3) / 3, 1,-1/
      DATA (NHEL(I,  24),I=1,3) / 3, 1, 1/
      DATA IDEN/ 4/
C     ----------
C     BEGIN CODE
C     ----------
...
C     ----------
      ...
      CALL OXXXXX(P(0,3),MDL_MNEU2,NHEL(3),+1*IC(3),W(1,3))
C     Amplitude(s) for diagram number 1
      CALL FRV1_2_3_4C1_0(W(1,1),W(1,3),W(1,2),GC_1338,GC_1300,GC_1097
     $ ,GC_963,AMP(1))
