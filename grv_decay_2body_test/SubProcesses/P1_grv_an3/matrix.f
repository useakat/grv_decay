...
C     
      ...
      DATA (NHEL(I,  13),I=1,3) / 3,-1,-1/
      DATA (NHEL(I,  14),I=1,3) / 3,-1, 1/
      DATA (NHEL(I,  15),I=1,3) / 3, 1,-1/
      DATA (NHEL(I,  16),I=1,3) / 3, 1, 1/
      DATA IDEN/ 4/
C     ----------
C     BEGIN CODE
C     ----------
...
C     Amplitude(s) for diagram number 1
      CALL FRV2_4C1_0(W(1,1),W(1,3),W(1,2),GC_1356,GC_699,AMP(1))
