...
C     
      ...
      DATA (NHEL(I,   3),I=1,3) /-3,-1, 1/
      DATA (NHEL(I,   4),I=1,3) /-3, 1,-1/
      DATA (NHEL(I,   5),I=1,3) /-3, 1, 0/
      ...
      DATA (NHEL(I,  20),I=1,3) / 3,-1, 0/
      DATA (NHEL(I,  21),I=1,3) / 3,-1, 1/
      DATA (NHEL(I,  22),I=1,3) / 3, 1,-1/
      DATA (NHEL(I,  23),I=1,3) / 3, 1, 0/
...
C     Amplitude(s) for diagram number 1
      CALL FRV1_2_3_4C1_0(W(1,1),W(1,2),W(1,3),GC_1257,GC_1219,GC_1095
     $ ,GC_961,AMP(1))
      JAMP(1)=+AMP(1)
      MATRIX = 0.D0
      DO I = 1, NCOLOR
